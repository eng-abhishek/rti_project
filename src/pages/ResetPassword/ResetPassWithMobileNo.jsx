          ...
          <div className="row">
            <div className="col-md-12 col-lg-12 cus_col_form ">
              <div className="form_heading">
                ...
                <p id="otp-error"></p>
                <form  className="input_cust" id="resetPassMobileNo" onSubmit={handleFormSubmit}>
                  <div className="form-group group col-md-12 col-12">
                    <input type="text" className="form-control cus-form-control" onChange={handelFormData} placeholder="" name="email_id" />
                    <label className="form__label" htmlFor="">Username <span className="error">(email ID)</span></label>
                  </div>

                  <div className="form-group group col-md-12 col-12">
                    <input type="text" className="form-control cus-form-control" onChange={handelFormData} minLength={10} maxLength={10}
                      name="mobile_no"/>
